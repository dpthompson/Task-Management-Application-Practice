...
namespace Task_Management_Application_Practice
{
    ...
    public static class SQLQuery
    {
        ...
        public static string PopulateAssignmentGridView = "Select TaskID,Title,DueDate,Priority from New_Task_Table order by Priority desc,DueDate desc";//used to populate the datagrid view on the view task form
